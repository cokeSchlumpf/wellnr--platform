...
/**
 * This class wraps {@link Config} and adds some features like environment and role awareness.
 *
...
public final class Configs {
     ...
     */
    public static final String SYS_WELLNR_ENVIRONMENT = "wellnr.environment";
     ...
     */
    public static final String ENV_WELLNR_ROLE = "WELLNR_ROLE";
    ...
    /**
     * The name of the current environment, based on "wellnr.environment" system environment variable.
     */
    private static final String environmentName = system.hasPath(SYS_WELLNR_ENVIRONMENT) ?
        system.getString(SYS_WELLNR_ENVIRONMENT) : environment.hasPath(ENV_WELLNR_ENVIRONMENT) ?
        environment.getString(ENV_WELLNR_ENVIRONMENT) : LOCAL_ENVIRONMENT;

    /**
     * The name of the current instance's role, based on "wellnr.role" system environment variable.
     */
    private static final String roleName = system.hasPath(SYS_WELLNR_ROLE) ?
        system.getString(SYS_WELLNR_ROLE) : environment.hasPath(ENV_WELLNR_ROLE) ?
        environment.getString(ENV_WELLNR_ROLE) : null;
    ...
    /**
     * @return The name of the current environment, based on "wellnr.environment" system environment variable.
     */
    ...
    /**
     * @return The name of the current instance's role, based on "wellnr.role" system environment variable.
     */
                    ...
                    try {
                        ...
                        if (field
                            ...
                            if (genericType.equals(Boolean.class)) {
                                ...
                                LOG.warn(String.format("Field '%s.%s' has unknown generic type for configuration: " +
                                    "List<%s>", configClass
                                    .getSimpleName(), field.getName(), genericType));
                            }
                        } else {
                        ...
                        if (field.getAnnotationsByType(com.wellnr.platform.common.config.annotations.Optional.class).length == 0) {
    ...
    private static class ConfigBuilder {
         ...
         * <p>
         * The environment name can be set in the system variable/ JVM argument
         * {@link ConfigBuilder#SYS_WELLNR_ENVIRONMENT}.
         *
        ...
        public ConfigBuilder withResource(String resourceFileName) {
            if (this
                ...
                LOG.debug(String.format("Configuration resource with name '%s' does not exist - Will be skipped",
                    resourceFileName));
                return this;
            }
        }
         ...
         * <p>
         * The role can be defined in the system variable/ JVM argument {@link ConfigBuilder#SYS_WELLNR_ROLE}.
         *
         * @return A new {@link ConfigBuilder} instance
         */
